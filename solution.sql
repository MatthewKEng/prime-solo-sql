...
SELECT * WHERE transactions_attempted>='9';
...
SELECT * WHERE account_balance>'100.00';
-- 8. Add a new record.
INSERT INTO syntax_practice (username, city, transactions_completed, transactions_attempted, account_balance) VALUES ('matt', 'minneapolis', '12', '12', '1250000');
...
DELETE * FROM syntax_practice WHERE transactions_completed<'5' AND city='miami' OR 'phoenix'; 
